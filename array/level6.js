...
//Q1. Use the filter() method to create a new array that contains only the even numbers from the scores array. Expected output is [6,4,2]
...
console.log(scores.filter(loop1))
