...
/*Q3: Object Mapping Create an object representing a car with properties for brand, model, and year.
  Write a script that checks if the car is "antique" (older than 25 years from the current year 2026). */