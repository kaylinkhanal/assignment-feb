...
const primaryAddressDetails = Object.values(user.address.primaryAddress);
console.log(primaryAddressDetails);
...
console.log(Object.values(user.address).filter(value => value !== null).length);